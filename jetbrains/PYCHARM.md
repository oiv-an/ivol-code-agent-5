...
Отдельная сборка **5.16.234** предназначена для **PyCharm 2025.1.1.1, PY-251.25410.159**. Это не пакет для PhpStorm и IntelliJ IDEA 2026.2: у них другая версия платформы и Java.

## Установка

1. Скачайте [ZIP для PyCharm 2025.1](https://github.com/oiv-an/ivol-code-agent-5/releases/download/v5.16.234/ivol-code-agent-5-5.16.234-pycharm-2025.1.zip).
...
Сборка 5.16.234 содержит общее исправление сохранения истории на Windows (`EPERM: fsync`, `API conversation history could not be saved`). Оно включено также в VS Code, PhpStorm и оба целевых варианта IDEA. Исправление параллельного запуска нативных библиотек из 5.16.233 сохранено. Удаление задач или настроек перед установкой не требуется.
