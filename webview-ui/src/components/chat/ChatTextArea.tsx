...
import { VolumeX, Pin, Check, WandSparkles, SendHorizontal, Paperclip, MessageSquareX, AtSign } from "lucide-react"
				...
				<div className="absolute bottom-2 end-2 z-30 flex items-center gap-1">
					...
					<StandardTooltip content="Add Context (@)">
						<button
							...
							<AtSign className={cn("w-4", "h-4", { hidden: containerWidth < 235 })} />
						</button>
					</StandardTooltip>
					{isEditMode && (
