...
Click the magic wand icon to make your prompt clearer and more complete. IVOL Code will rewrite it to get better results.

# Add files or folders for context

Mention files or folders in your prompt. IVOL Code will use them to better understand and respond to your request.
